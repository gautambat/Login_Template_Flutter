...
import 'package:logintest/signup/signup_form.dart';
import 'package:logintest/signup/signup_image.dart';
import 'package:logintest/signup/signup_intro.dart';
...
class _SignUpMainState extends State<SignUpMain> {
  ...
  void _arrayImageFiles() {
    ...
    if(_userDataMap['image0'] != null) {
      _image = _userDataMap['image0'];
    }
  ...
  Future<void> _addUserImagesToFirebaseStorage(FirebaseUser firebaseUser) async {
    try {
      if (_image != null) {
        _uploadUserImages(_image, firebaseUser.uid, 'image0',firebaseUser);
      }else {
  ...
  Future<void> _uploadUserImages(File imageFile, String userID,String imageCount, FirebaseUser firebaseUser) async {
    try {
    ...
    try {
      ...
      if (firebaseUser != null) {
        ...
        if (documents.length == 0) {
          ...
          await prefs.setString('image0', _imageString);
